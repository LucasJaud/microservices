...
require (
	github.com/LucasJaud/microservices-proto/golang/order v0.0.1
	github.com/LucasJaud/microservices-proto/golang/payment v0.0.1
	github.com/LucasJaud/microservices-proto/golang/shipping v0.0.1
